...
-- Block client writes on tables managed by edge functions only
DO $blk$
DECLARE t text;
BEGIN
  FOR t IN SELECT unnest(ARRAY[
    'rooms','room_players','room_actions','room_chat','room_text_chat','player_profiles',
    'sala_chat','room_chat_flags','admin_passwords','chat_flag_audit','account_links','account_deletion_requests'
  ]) LOOP
  ...
  END LOOP;
  -- For these, also block insert (others have explicit insert policies above)
  FOR t IN SELECT unnest(ARRAY['rooms','room_players','room_actions','room_chat','room_text_chat','player_profiles','admin_passwords','chat_flag_audit','account_links']) LOOP
...
DO $rt1$ BEGIN ALTER PUBLICATION supabase_realtime ADD TABLE public.rooms; EXCEPTION WHEN duplicate_object THEN NULL; END $rt1$;
DO $rt2$ BEGIN ALTER PUBLICATION supabase_realtime ADD TABLE public.room_players; EXCEPTION WHEN duplicate_object THEN NULL; END $rt2$;
DO $rt3$ BEGIN ALTER PUBLICATION supabase_realtime ADD TABLE public.room_actions; EXCEPTION WHEN duplicate_object THEN NULL; END $rt3$;
DO $rt4$ BEGIN ALTER PUBLICATION supabase_realtime ADD TABLE public.room_chat; EXCEPTION WHEN duplicate_object THEN NULL; END $rt4$;
DO $rt5$ BEGIN ALTER PUBLICATION supabase_realtime ADD TABLE public.room_text_chat; EXCEPTION WHEN duplicate_object THEN NULL; END $rt5$;
DO $rt6$ BEGIN ALTER PUBLICATION supabase_realtime ADD TABLE public.player_profiles; EXCEPTION WHEN duplicate_object THEN NULL; END $rt6$;
DO $rt7$ BEGIN ALTER PUBLICATION supabase_realtime ADD TABLE public.sala_chat; EXCEPTION WHEN duplicate_object THEN NULL; END $rt7$;
DO $rt8$ BEGIN ALTER PUBLICATION supabase_realtime ADD TABLE public.room_chat_flags; EXCEPTION WHEN duplicate_object THEN NULL; END $rt8$;
DO $rt9$ BEGIN ALTER PUBLICATION supabase_realtime ADD TABLE public.account_links; EXCEPTION WHEN duplicate_object THEN NULL; END $rt9$;